...
export default function Navbar() {
  return (
    <header className="flex items-center justify-between p-8 md:pl-10 lg:pt-10">
      <div>
      ...
      <nav className="font-BarlowCondensed text-white bg-[#ffffff0a] backdrop-blur-2xl pl-20 pr-32 hidden md:block">
        <ul className="flex gap-10 text-sm tracking-[3px] lg:text-base">
          ...
          <li className="hover:border-b-[3px] border-white/30 border-solid">
            <a href="/destination" className="inline-block py-10">
              <span className="hidden lg:inline">01</span> Destination
            </a>
          </li>
          <li className="hover:border-b-[3px] border-white/30 border-solid">
            <a href="/crew" className="inline-block py-10">
              <span className="hidden lg:inline">02</span> Crew
            </a>
          </li>
          <li className="hover:border-b-[3px] border-white/30 border-solid">
            <a href="/technology" className="inline-block py-10">
